...
- 歌詞参照がない時も、下書きの行分けでは無音区間の検出結果を使って、無音またぎの不自然な連結を減らします。
- 歌詞参照がない時は、1〜2文字や極端に短い clip を、そのまま残さず前後へ寄せてまとめる後処理も入れています。
- 歌詞参照がない時は、隣どうしの境界を波形の谷へ少し寄せて、切れ目が音の弱い所へ乗りやすくしています。
- 歌詞参照がない時は、行の文字数が長くなりすぎる前に分ける専用ルールも使っています。
- 歌詞参照がない時は、時間合わせの探索窓も広めに取り、近い歌詞どうしは 2 行までまとめて時間合わせへ渡します。
